 ...
 */
		// Handler for Zotero PowerPoint integration
		...
		if (ppt) {
			...
			Zotero.setTimeout(function() { Zotero.Integration.pptCommand(citationStyle) }, 0);
		}
/**
 * End of addition For Zotero PowerPoint
 */
